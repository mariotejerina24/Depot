...
class EditorialsControllerTest < ActionController::TestCase
  ...
  test "should create editorial" do
    assert_difference('Editorial.count') do
      post :create, editorial: { address: @editorial.address, email: @editorial.email, name: @editorial.name, phone: @editorial.phone }
    end
  ...
  test "should update editorial" do
    patch :update, id: @editorial, editorial: { address: @editorial.address, email: @editorial.email, name: @editorial.name, phone: @editorial.phone }
    assert_redirected_to editorial_path(assigns(:editorial))
  end
